...
"""
S_password = input("please enter password for server")
dt = datetime.datetime.now()
time =int( dt.year+dt.month+dt.day+dt.hour+dt.minute+dt.second+dt.microsecond)
S_key = encrypt_header.key_gen(time)
S_password = encrypt_header.thread_encrypt(S_password,S_key)
print(S_password)
"""
#end server password
